 ...
 */
public class GroupReportByStateProcessor implements MessageProcessor {

  private final static Logger LOGGER = LoggerFactory.getLogger(GroupReportByStateProcessor.class);
  private final Message<JsonObject> message;
  private final Future<MessageResponse> result;

  private final GroupReportService service = new GroupReportService(DBICreator.getDbiForDsdbDS());

  public GroupReportByStateProcessor(Vertx vertx, Message<JsonObject> message) {
  ...
  public Future<MessageResponse> process() {
    try {
      ...
      GroupReportByStateCommand command =
          GroupReportByStateCommand.build(ebMessage.getRequestBody());
      GroupReportByStateCommand.GroupReportByStateCommandBean bean = command.asBean();
      ...
      List<PerformanceAndTSReportByGroupModel> report =
          this.service.fetchPerformanceAndTSReportByState(bean,
