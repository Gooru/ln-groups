...
public class RouteGroupHierarchyConfigurator implements RouteConfigurator {
  ...
  private static final Logger LOGGER =
      LoggerFactory.getLogger(RouteGroupHierarchyConfigurator.class);
  private EventBus eb;
  ...
  private void assignGroupHierarchy(RoutingContext routingContext) {
    RouteHandlerUtils.baseHandler(this.eb, routingContext,
        Constants.Message.MSG_OP_HIERARCHIES_GROUP_TENANT_ASSIGN,
