...
public class DataModel {
  ...
  private List<GroupPerformanceAggregatedDataReportModel> drilldown;
  ...
  public List<GroupPerformanceAggregatedDataReportModel> getDrilldown() {
    return drilldown;
  }

  public void setDrilldown(List<GroupPerformanceAggregatedDataReportModel> drilldown) {
