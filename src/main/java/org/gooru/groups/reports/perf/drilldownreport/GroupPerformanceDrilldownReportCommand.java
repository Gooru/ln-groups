 ...
 *
 */
public class GroupPerformanceDrilldownReportCommand {

  private static final Logger LOGGER =
      LoggerFactory.getLogger(GroupPerformanceDrilldownReportCommand.class);
  ...
  public GroupPerformanceDrilldownReportCommand(Long hierarchyId, Set<String> tenants, Long groupId,
  ...
  public static GroupPerformanceDrilldownReportCommand build(JsonObject requestBody,
      JsonObject tenantJson) {
    GroupPerformanceDrilldownReportCommand command = buildFromJson(requestBody, tenantJson);
    command.validate();
    return command;
  }
  ...
  private static GroupPerformanceDrilldownReportCommand buildFromJson(JsonObject requestBody,
      JsonObject tenantJson) {
    ...
    return new GroupPerformanceDrilldownReportCommand(hierarchyId, tenants, groupId, groupType,
        month, year, frequency, tenantId, tenantRoot);
  }

  public GroupPerformanceDrilldownReportCommandBean asBean() {
    GroupPerformanceDrilldownReportCommandBean bean =
        new GroupPerformanceDrilldownReportCommandBean();
  ...
  static class GroupPerformanceDrilldownReportCommandBean {
    private Long hierarchyId;
