...
public class GroupReportByCountryCommand {
  ...
  private final static Logger LOGGER = LoggerFactory.getLogger(GroupReportByCountryCommand.class);
  ...
  public GroupReportByCountryCommand(Long countryId, String frequency, Integer week,
  ...
  private static GroupReportByCountryCommand buildFromJson(JsonObject request) {
    ...
    return new GroupReportByCountryCommand(country, frequency, week, month, year, subject, framework);
  }
