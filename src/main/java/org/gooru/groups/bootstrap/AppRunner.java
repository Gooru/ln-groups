...
package org.gooru.groups.bootstrap;
...
import org.gooru.groups.app.components.Initializer;
import org.gooru.groups.app.components.Initializers;
...
public class AppRunner {
  ...
  private void deployVerticles(Future<Void> startFuture) {
    ...
    for (Entry<String, Object> verticle : verticles) {
  ...
  private static void setupSystemProperties() {
    ...
    for (Entry<String, Object> property : systemProperties) {
