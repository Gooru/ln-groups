...
public class DataModelForClass {
  ...
  private List<AggregatedDataGroupReportForClassModel> drilldown;
  ...
  public List<AggregatedDataGroupReportForClassModel> getDrilldown() {
    return drilldown;
  }

  public void setDrilldown(List<AggregatedDataGroupReportForClassModel> drilldown) {
