 ...
 * @author renuka
 */
public final class WeeklyClassStudentSummaryCommandBuilder {

  private static final Logger LOGGER =
      LoggerFactory.getLogger(WeeklyClassStudentSummaryCommandBuilder.class);
  private static final ResourceBundle RESOURCE_BUNDLE = ResourceBundle.getBundle("messages");

  private WeeklyClassStudentSummaryCommandBuilder() {
