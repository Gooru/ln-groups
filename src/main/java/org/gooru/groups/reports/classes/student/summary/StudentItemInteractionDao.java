...
public interface StudentItemInteractionDao {
  ...
  @SqlQuery("SELECT date_in_time_zone from collection_performance where class_id =:classId and actor_id = :actorId ORDER BY date_in_time_zone DESC LIMIT 1")
